...
const columns = [
    { key: 'nama_jenis_hubungan_kerja', label: 'Nama Jenis Hubungan Kerja', sortable: true },
];
    ...
    return (
        <div className="space-y-6">
            <div className="flex items-center justify-between">
                <div>
                    <h1 className="text-2xl font-bold text-foreground">Jenis Hubungan Kerja</h1>
                    <p className="text-sm text-muted-foreground/80 mt-1">Kelola data master jenis hubungan kerja</p>
                </div>
                <button
