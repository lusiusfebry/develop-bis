...
import { subGolonganService } from '@/services/master.service';
...
const formFields: FieldConfig[] = [
    { name: 'nama_sub_golongan', label: 'Nama Sub Golongan', type: 'text', required: true },
...
export default function SubGolonganPage() {
    const {
        ...
        handleSubmit,
        isSubmitting,
    } = useMasterData<SubGolongan>(subGolonganService, ['master-sub-golongan']);
    ...
    return (
        <div className="space-y-6">
            <div className="flex items-center justify-between">
                <div>
                    <h1 className="text-2xl font-bold text-foreground">Sub Golongan</h1>
                    <p className="text-sm text-muted-foreground/80 mt-1">Kelola data master sub golongan</p>
                </div>
                <button
            ...
            <MasterDataForm
                ...
                title={editingItem ? 'Edit Sub Golongan' : 'Tambah Sub Golongan'}
                fields={formFields}
